...
1. What is the DOM?
  The DOM stands for 'Document Object Model' and it is the physical representation of the node strcuture of the HTML document via JavaScript.

2. What is an event?
  An event is a method by which the site becomes dynamic.

3. What is an event listener?
  An event listener is code that listens for an even ton the element selected.

4. Why would we convert a NodeList into an Array?
  Converting a NodeList to an array allows us to work with it easier by utlizing array methods to manipulate the data.
  
5. What is a component?
  A component is a reusable piece of code. It also allows our code to be DRYer.
